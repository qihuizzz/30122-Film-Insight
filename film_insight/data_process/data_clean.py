...
print(douban)
rottentomatoes = pd.read_excel(
    pathlib.Path(__file__).parent / "../data/rottentomatoes_data.xlsx"
)
...
stopwords = stopwordslist(pathlib.Path(__file__).parent / "../data/chinese.txt")
...
rottentomatoes.to_excel(
    pathlib.Path(__file__).parent / "../data/rottentomatoes_clean.xlsx"
)
