...
note_LDA_R = '''From the inflection points in the figure we can observe that the average cosine similarity is 1 when the number of topics is 1. This is because there is only one topic, so it is most similar to itself. \n\nSo we chose two topics for rottentomatoes and here are the top 30 keywords with the highest weights under each topic. \n\n Theme 0:war, Japan, occur, surrender, Germany, character, really, like, realistic, end, film, a bit, humanity, two, detail, time, hope, Akira Kurosawa, scene, theme, thing, simple, deployment, dark, Shadow Warrior, of, British, lack, segment, powerful \n\nTheme 1:documentary, World War II, Hiroshima, this, horror, work, director, United States, explosion, shocking, Jewish, sacrifice, shot, audience, government, video, innocent, movie, scene, value, production, perspective, significance, Europe, in the film, event, objective, this battle, death, cruel\n\nA comprehensive analysis of these themes and keywords shows that Douban users are not only concerned with historical accuracy and the profundity of events when discussing war movies, but also with the artistic performance, emotional expression and educational value of the films. These discussions reflect how audiences in the Chinese context understand and digest different aspects of war movies, from serious historical topics to the aesthetic and technical aspects of the movies.'''
note_LDA_D = '''From the graph, we can observe the following: when the number of topics is 1, the average cosine similarity is 1. This is because there is only one topic, so its similarity to itself is maximized. When we increase the number of topics from 1 to 2, the average cosine similarity decreases dramatically, which means that adding a second topic significantly increases the differentiation between topics. As the number of themes increases to 3 or more, the mean cosine similarity is almost zero or very close to zero, indicating that the themes are very independent of each other and have little overlap.\n\nSo we've chosen three themes for Douban, and here are the top 30 keywords with the highest weights under each theme.\n\nTheme 0:war, Japan, occur, surrender, Germany, character, really, like, realistic, end, film, a bit, humanity, two, detail, time, hope, Akira Kurosawa, scene, theme, thing, simple, deployment, dark, Shadow Warrior, of, British, lack, segment, powerful\n\nTheme 1:documentary, World War II, Hiroshima, this, horror, work, director, United States, explosion, shocking, Jewish, sacrifice, shot, audience, government, video, innocent, movie, scene, value, production, perspective, significance, Europe, in the film, event, objective, this battle, death, cruel\n\nTheme 2:history, atomic bomb, story, BBC, world, forever, feel, picture, animation, battlefield, army, people, conclusion, description, military, can only, express, shadow, perspective, dispatch, Nazi, Black Rain, process, Napoleon, die, the, epic, plot, every time, comment\n\nDouban users are not only concerned with historical accuracy and the profundity of events when discussing war movies, but also with the artistic performance, emotional expression and educational value of the films. These discussions reflect how audiences in the Chinese context understand and digest different aspects of war movies, from serious historical topics to the aesthetic and technical aspects of the movies.'''
